...
class AnsibleDockerClient(Client):
    ...
    def _image_lookup(self, name, tag): 
        '''
        Including a tag in the name parameter we send to the docker-py images method does work
        consistently. So instead, we get the result set for name and manually check if the tag
        exists.
        '''
        try:
